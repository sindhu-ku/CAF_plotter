...
* simple_macro directory: A simple C++ macro that plots the energy of reconstructed particles tagged as muons, can take structured or flat CAFs (works on DUNE gpvm)
* python_flatCAF directory: Plots truth and reco interaction vertex x from flat CAFs using uproot and pandas, can only take flat CAFs (does not work on DUNE gpvm)
